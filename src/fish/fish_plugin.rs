...
impl Plugin for FishPlugin {
    fn build(&self, app: &mut AppBuilder) {
        ...
        app.add_system(moviment_system::move_fish_forward.system());
        app.add_system_to_stage("COLLISION_SYSTEM", collision_system::detect_fish_collision.system());
        app.add_system(death_system::send_fish_death_by_energy.system()  );
        app.add_system(death_system::receive_fish_death.system() );
